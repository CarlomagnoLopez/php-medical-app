...
if ($_REQUEST) {
    ...
    switch ($validationsLevel["level"]) {
        case 0:
            ...
            header("Location: http://ec2-54-208-211-67.compute-1.amazonaws.com/php-medical-app-dev/signin");
        ...
        case 1:
            ...
            header("Location:http://ec2-54-208-211-67.compute-1.amazonaws.com/php-medical-app-dev/expired");
            $response['data'] = "success";
            $response['error'] = false;
...
function getSMSTestAndUpdate($phone, $typeSMS, $idToUpdate)
{
    try {
        ...
        $longLink = "http://ec2-54-208-211-67.compute-1.amazonaws.com/php-medical-app-dev/door/integration/maindummy.php?smsvalidations=" . $stringArray;
        $data_array =  array(
